...
`,[F("splitor",`
 ...
 `),q("checked",{color:"var(--n-button-text-color-hover)"})]),I("focus",[j("&:not(:active)",[F("state-border",{boxShadow:"var(--n-button-box-shadow-focus)"})])])]),I("checked",`
