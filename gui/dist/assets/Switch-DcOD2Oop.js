...
`,[i("children-placeholder",`
 ...
 cursor: not-allowed;
 opacity: .5;
 `)])]),jr=Object.assign(Object.assign({},ze.props),{size:{type:String,default:"medium"},value:{type:[String,Number,Boolean],default:void 0},loading:Boolean,defaultValue:{type:[String,Number,Boolean],default:!1},disabled:{type:Boolean,default:void 0},round:{type:Boolean,default:!0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],checkedValue:{type:[String,Number,Boolean],default:!0},uncheckedValue:{type:[String,Number,Boolean],default:!1},railStyle:Function,rubberBand:{type:Boolean,default:!0},onChange:[Function,Array]});let ge;const Yr=H({name:"Switch",props:jr,slots:Object,setup(e){ge===void 0&&(typeof CSS<"u"?typeof CSS.supports<"u"?ge=CSS.supports("width","max(1px)"):ge=!1:ge=!0);const{mergedClsPrefixRef:a,inlineThemeDisabled:o}=rt(e),h=ze("Switch","-switch",Nr,Or,e,a),s=it(e),{mergedSizeRef:v,mergedDisabledRef:l}=s,d=P(e.defaultValue),u=ke(e,"value"),c=nt(u,d),g=M(()=>c.value===e.checkedValue),p=P(!1),m=P(!1),R=M(()=>{const{railStyle:b}=e;if(b)return b({focused:m.value,checked:g.value})});function x(b){const{"onUpdate:value":$,onChange:B,onUpdateValue:V}=e,{nTriggerFormInput:O,nTriggerFormChange:K}=s;$&&F($,b),V&&F(V,b),B&&F(B,b),d.value=b,O(),K()}function ne(){const{nTriggerFormFocus:b}=s;b()}function j(){const{nTriggerFormBlur:b}=s;b()}function ae(){e.loading||l.value||(c.value!==e.checkedValue?x(e.checkedValue):x(e.uncheckedValue))}function A(){m.value=!0,ne()}function L(){m.value=!1,j(),p.value=!1}function U(b){e.loading||l.value||b.key===" "&&(c.value!==e.checkedValue?x(e.checkedValue):x(e.uncheckedValue),p.value=!1)}function W(b){e.loading||l.value||b.key===" "&&(b.preventDefault(),p.value=!0)}const ee=M(()=>{const{value:b}=v,{self:{opacityDisabled:$,railColor:B,railColorActive:V,buttonBoxShadow:O,buttonColor:K,boxShadowFocus:ie,loadingColor:q,textColor:le,iconColor:Y,[I("buttonHeight",b)]:_,[I("buttonWidth",b)]:Me,[I("buttonWidthPressed",b)]:pe,[I("railHeight",b)]:E,[I("railWidth",b)]:X,[I("railBorderRadius",b)]:Re,[I("buttonBorderRadius",b)]:te},common:{cubicBezierEaseInOut:oe}}=h.value;let se,ce,de;return ge?(se=`calc((${E} - ${_}) / 2)`,ce=`max(${E}, ${_})`,de=`max(${X}, calc(${X} + ${_} - ${E}))`):(se=Be((N(E)-N(_))/2),ce=Be(Math.max(N(E),N(_))),de=N(E)>N(_)?X:Be(N(X)+N(_)-N(E))),{"--n-bezier":oe,"--n-button-border-radius":te,"--n-button-box-shadow":O,"--n-button-color":K,"--n-button-width":Me,"--n-button-width-pressed":pe,"--n-button-height":_,"--n-height":ce,"--n-offset":se,"--n-opacity-disabled":$,"--n-rail-border-radius":Re,"--n-rail-color":B,"--n-rail-color-active":V,"--n-rail-height":E,"--n-rail-width":X,"--n-width":de,"--n-box-shadow-focus":ie,"--n-loading-color":q,"--n-text-color":le,"--n-icon-color":Y}}),T=o?at("switch",M(()=>v.value[0]),ee,e):void 0;return{handleClick:ae,handleBlur:L,handleFocus:A,handleKeyup:U,handleKeydown:W,mergedRailStyle:R,pressed:p,mergedClsPrefix:a,mergedValue:c,checked:g,mergedDisabled:l,cssVars:o?void 0:ee,themeClass:T==null?void 0:T.themeClass,onRender:T==null?void 0:T.onRender}},render(){const{mergedClsPrefix:e,mergedDisabled:a,checked:o,mergedRailStyle:h,onRender:s,$slots:v}=this;s==null||s();const{checked:l,unchecked:d,icon:u,"checked-icon":c,"unchecked-icon":g}=v,p=!(Ae(u)&&Ae(c)&&Ae(g));return n("div",{role:"switch","aria-checked":o,class:[`${e}-switch`,this.themeClass,p&&`${e}-switch--icon`,o&&`${e}-switch--active`,a&&`${e}-switch--disabled`,this.round&&`${e}-switch--round`,this.loading&&`${e}-switch--loading`,this.pressed&&`${e}-switch--pressed`,this.rubberBand&&`${e}-switch--rubber-band`],tabindex:this.mergedDisabled?void 0:0,style:this.cssVars,onClick:this.handleClick,onFocus:this.handleFocus,onBlur:this.handleBlur,onKeyup:this.handleKeyup,onKeydown:this.handleKeydown},n("div",{class:`${e}-switch__rail`,"aria-hidden":"true",style:h},D(l,m=>D(d,R=>m||R?n("div",{"aria-hidden":!0,class:`${e}-switch__children-placeholder`},n("div",{class:`${e}-switch__rail-placeholder`},n("div",{class:`${e}-switch__button-placeholder`}),m),n("div",{class:`${e}-switch__rail-placeholder`},n("div",{class:`${e}-switch__button-placeholder`}),R)):null)),n("div",{class:`${e}-switch__button`},D(u,m=>D(c,R=>D(g,x=>n(Ze,null,{default:()=>this.loading?n(tt,{key:"loading",clsPrefix:e,strokeWidth:20}):this.checked&&(R||m)?n("div",{class:`${e}-switch__button-icon`,key:R?"checked-icon":"icon"},R||m):!this.checked&&(x||m)?n("div",{class:`${e}-switch__button-icon`,key:x?"unchecked-icon":"icon"},x||m):null})))),D(l,m=>m&&n("div",{key:"checked",class:`${e}-switch__checked`},m)),D(d,m=>m&&n("div",{key:"unchecked",class:`${e}-switch__unchecked`},m)))))}});export{Yr as _,Pr as a,qr as b,Kr as c,_r as i,it as u};
