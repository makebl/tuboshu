...
- 🚀 ​**账户多开** - 相同网站可实现多开，支持账户隔离，独立运行互不干扰
- ⚡️ ​**闪电切换** - 全局快捷键快速显示/隐藏（默认 `Ctrl/Cmd + H`）
- 🎨 ​**深度定制** - 自定义窗口尺寸、图标、启动参数
...
<table>
    ...
    <tr>
        <td><img src=https://github.com/user-attachments/assets/5435c62a-9b5f-4695-8f90-7bf0682fc103 width=600/></td>
